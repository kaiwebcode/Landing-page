      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 animate-fade-right">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-effect w-fit">
            ...
            <span className="text-sm font-medium">Introducing v0 Platform</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="px-8 py-4 rounded-full font-semibold text-white bg-linear-to-r from-blue-500 to-purple-500 hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 group"
            >
              Get Started Free
              <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-8 py-4 rounded-full font-semibold text-foreground glass-effect hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
              Watch Demo
            </button>
          </div>
